    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                ...
                <form action="{{ route('outreaches.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="">
                        <div>
                            <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="p_contact" class="block w-96 appearance-none rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="person contacted" required>
                        </div>
                        ...
                        <div>
                            <div class="flex flex-wrap">
                                <div class="w-1/3 p-2 flex items-center">
                                    <input id="Call" type="checkbox" name="types[]" value="Phone Call" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="Call" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Phone Call</label>
                                </div>
                                <div class="w-1/3 p-2 flex items-center">
                                    <input id="Text" type="checkbox" name="types[]" value="E-mail/Text Info" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="Text" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">E-mail/Text Info</label>
                                </div>
                                <div class="w-1/3 p-2 flex items-center">
                                    <input id="Home" type="checkbox" name="types[]" value="Home Visit" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="Home" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Home Visit</label>
                                </div>
                                <div class="w-1/3 p-2 flex items-center">
                                    <input id="One" type="checkbox" name="types[]" value="One-On-One" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <div>
                            ...
                            <textarea name="result" id="result" class="block w-96 appearance-none rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="result of contact" required></textarea>
                        </div>
