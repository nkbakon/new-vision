...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="min-w-screen min-h-screen bg-gradient-to-r from-indigo-900 to-indigo-400 flex items-center justify-center px-5 py-5">
            <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
                <div class="md:flex w-full">
                    <div class="hidden md:flex w-1/2 bg-white py-10 px-10 justify-center">                        
                        <div class="w-full mt-8">
                            <div class="flex items-center justify-center">
                                <img width="200px" height="150px" src="{{ asset('assets/logo.png') }}" alt="logo"/>
                            </div>                            
                    ...
                    <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                        <div class="flex items-center justify-center md:hidden">
                            <img width="150px" height="100px" src="{{ asset('assets/logo.png') }}" alt="logo"/>
                        </div>   
