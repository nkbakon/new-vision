                ...
                <form action="{{ route('logs.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="">
                        ...
                        <div>
                            ...
                            <input type="text" name="action" class="block w-96 appearance-none rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="action" required>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="result" class="block w-96 appearance-none rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="outcome/result" required>
                        </div>
                        @error('result') <span class="text-red-500 error">{{ $message }}</span><br> @enderror
                        <br>
                        <div>
                            <label for="length">Length of Session</label><br>
                            <input type="text" name="length" class="block w-96 appearance-none rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="length of session" required>
                        </div>
