    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                ...
                <form action="{{ route('consents.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="">
                        ...
                        <div class="flex justify-between mb-2">
                            <span><span class="font-semibold">CONSENT FOR MEDICAL TREATMENT</span><br>
                                ...
                                <input type="text" name="telephone" class="mt-2 block w-96 appearance-none rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="telephone" required>    
                            </span>
                        </div> 
                        <br>
                        <div class="flex justify-between mb-2">
                        ...
                        <div>
                            ...
                            <input type="text" name="doctor" class="block w-96 appearance-none rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="family doctor or specialist" required>
                        </div>
                        @error('doctor') <span class="text-red-500 error">{{ $message }}</span><br> @enderror
                        <br>
                        <div>
                            <label for="phone">Phone Number</label><br>
                            <input type="text" name="phone" class="block w-96 appearance-none rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="phone number" required>
                        </div>
                        @error('phone') <span class="text-red-500 error">{{ $message }}</span><br> @enderror
                        <br>
                        <div>
                            <label for="insurance">Insurance Company</label><br>
                            <input type="text" name="insurance" class="block w-96 appearance-none rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="insurance company" required>
                        </div>
                        @error('insurance') <span class="text-red-500 error">{{ $message }}</span><br> @enderror
                        <br>
                        <div>
                            <label for="hospital">Hospital Preference</label><br>
                            <input type="text" name="hospital" class="block w-96 appearance-none rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="hospital preference" required>
                        </div>
                        @error('hospital') <span class="text-red-500 error">{{ $message }}</span><br> @enderror
                        <br>
                        <div>
                            <label for="allergies">Allergies</label><br>
                            <input type="text" name="allergies" class="block w-96 appearance-none rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="allergies" required>
                        </div>
